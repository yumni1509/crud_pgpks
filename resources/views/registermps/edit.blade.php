...
<form action="{{ route('registermps.update',$registermp->id) }}" method="POST">
    ...
    @method('PUT')
     ...
     <div class="row">
        <div class="row">
            <div class="col-md-6">
                <p class="card-category"><b>Edit Company Details</b></p>
                <div class="form-group">
                    <label for="companyname" class="form-label">Company Name</label>
                    <input type="text" name="companyname" value="{{ $registermp->companyname }}" id="companyname" class="form-control" placeholder="Company name">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input id="companyaddr" name="companyaddr" value="{{ $registermp->companyaddr }}" placeholder="Enter your company address" onFocus="geolocate()" type="text" class="form-control">
        ...
        <div class="row">
            ...
            <div class="col-md-3">                        
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="country" name="country" value="{{ $registermp->country }}" placeholder="Country">
                </div>
            </div>
        </div>
        <div class="row">                                          
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" id="contactperson" name="contactperson" value="{{ $registermp->contactperson }}"  class="form-control" placeholder="Contact person">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="tel" id="phoneno" name="phoneno" value="{{ $registermp->phoneno }}" class="form-control" placeholder="Mobile number">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="email" value="{{ $registermp->email }}" class="form-control" placeholder="Email">
        ...
        <div class="row">                                          
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select id="q1" name="q1" value="{{ $registermp->q1 }}" class="form-control">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select id="q2" name="q2" value="{{ $registermp->q2 }}" class="form-control" placeholder="please select">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select id="q3" name="q3" value="{{ $registermp->q3 }}" class="form-control" placeholder="please select">
                        <option value="Please select">Please select</option>
